/*
 * ContactEventDispatcher.h
 *
 *  Created on: May 28, 2015
 *      Author: gang wang
 */

#ifndef CONTACT_EVENT_DISPATCHER_H
#define CONTACT_EVENT_DISPATCHER_H
...
/**
 * 切换到线程触发Contactserivce事件
 */
class ContactService;
    
class ContactEventDispatcher {
public:
	ContactEventDispatcher(ContactService *contactService);
	~ContactEventDispatcher();
...
private:
    DefaultContactEventDispatcher* _default;
};
