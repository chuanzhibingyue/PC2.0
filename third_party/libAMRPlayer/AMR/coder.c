...
int coder_main (int argc, char *argv[])
{
  ...
  if (useModeFile) {
      ...
      else if (fopen_s (&file_modes, modefileName, "rt") || file_modes == NULL)
      {
  ...
  else if (fopen_s(&file_speech, fileName, "rb") || file_speech == NULL)
  {
  ...
  else if (fopen_s(&file_serial, serialFileName, "wb") || file_serial == NULL)
  {
