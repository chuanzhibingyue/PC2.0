...
// utils
    ...
    uc.modules.component.DatePicker = function (element, YMDInputId, onValueChange) {
        this.$parent = $(element);
        this.options = $.extend({}, defaults);
        this.onValueChange = onValueChange;
        this.$inputBox = ['<input type="text" id="' + YMDInputId + '" placeholder="" class="YMDInputBox"/>'];
        //input box
    ...
    jQuery.extend(uc.modules.component.DatePicker.prototype, {
        init: function () {
            this.fillStatic();
            this.resize();
            this.render();
        ...
        getDaysHtml: function (y, m) {
            ...
            prevDaysNum = Date.getDaysNum(year, month);
        ...
        trigger: function () {
            ...
            _this.$element.addClass('pickAdate-modal').css({
                ...
                top: (post.top + _this.$YMDInput.outerHeight() + offs[1] - 215) + 'px',
        ...
        timelistShow: function (time, type, value, startIndex, endIndex) {
            ...
            _ol.find('li').click(function (e) {
                ...
                var _tempstr = value.slice(startIndex, endIndex);
                value = value.replace(_tempstr, $(this).text());
        ...
        checkInputIsOk: function () {
            ...
            return new Date(_ymdvaluesz[0], _ymdvaluesz[1] - 1, _ymdvaluesz[2]);
        },
            ...
            var _this = this,
                ...
                exec = {
                    current: function () {
                        ...
                        $('ol.days:eq(1) li:contains(' + day + '):eq(0)').addClass('now');
                    },
                    prev: function () {
