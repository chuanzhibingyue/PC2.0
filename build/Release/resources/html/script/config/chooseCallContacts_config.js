...
[
    ...
    'src/js/modules/chooseCallContacts/SearchCallContactsEventListener.js',
    'src/js/modules/chooseCallContacts/ChooseCallContactsDataSet.js',
    'src/js/modules/chooseCallContacts/ChooseCallContactsManager.js',
    'src/js/modules/chooseCallContacts/ChooseCallContactsView.js',
	'src/js/modules/chooseCallContacts/ChooseCallSelectContactsView.js',
    'src/js/modules/chooseCallContacts/ChooseCallContacts.js'
]